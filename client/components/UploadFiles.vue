<template>
    <div class=" w-full">
        <div class="w-full">
            <label :for="this.id" class="w-full p-0 cursor-pointer mb-8">
                ...
                <input type="file" :id="this.id" v-on:change="change"/>
            </label>
        </div><br>
        
        <div v-for="(file,i) in files" :key="i" class="float-left relative p-4 border border-blue-500 text-center rounded-md ml-2">

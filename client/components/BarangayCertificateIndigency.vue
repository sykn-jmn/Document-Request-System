        ...
        <div class="absolute top-0 right-0 pt-4">
            ...
            <div class="grid grid-cols-3 gap-x-8 bg-transparent mt-20">
                ...
                <div class="col-span-2 text-justify pr-16 leading-normal">
                    ...
                    <p class="par_content">This is to certify that {{user.call_address}}. {{user.full_name}}, {{user.age}} years old {{user.civil_status}} Filipino citizen and a resident of {{user.purok}}, {{user.barangay}}, {{user.municipality}}, {{user.province}} for___ years more or less.</p><br>
